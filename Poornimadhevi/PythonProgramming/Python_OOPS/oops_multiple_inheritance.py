...
# set multiple inheritance :  when one class connected to two other parent classes, then it is
#                             called multiple inheritance.
# MRO :  Method resolution order look for the methods of the class will get priority depends on
#        order of class calling during the inheritance operation.
...
class Son(Father, Mother):
    ...
    def __init__(self, s_name, f_name, f_business, f_car, m_name, m_business):
        super().__init__(f_name, f_business, f_car)
        self.son_name = s_name
        self.mother_name = m_name
        # update mother_name variable in son class constructor
        self.mother_business = m_business
        # update mother_business variable in son class constructor
...
obj = Son('Mohit', 'Narendra', 'Builder', 'Safari', 'Neha', 'Fashion')
