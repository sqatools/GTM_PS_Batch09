...
class Son1(Father):   # setup single inheritance between father and son class.
    """
    ...
    """
    def __init__(self, s1_name, f_name, f_business, f_car):
        super().__init__(f_name, f_business, f_car)
        self.son_name = s1_name
...
class Son2(Father):   # setup single inheritance between father and son class.
    """
    When we setup inheritance between 2 classes then parent class constructor has to
    initialize in the child class constructor with the help of super() keyword.

    """
    def __init__(self, s2_name, f_name, f_business, f_car):
        super().__init__(f_name, f_business, f_car)
        self.son_name = s2_name
...
obj = Son1('Mohit', 'Narendra', 'Builder', 'Safari')
obj.show_family_details()

print("_"*50)

obj = Son2('Rahul', 'Narendra', 'Builder', 'Safari')
obj.show_family_details()
