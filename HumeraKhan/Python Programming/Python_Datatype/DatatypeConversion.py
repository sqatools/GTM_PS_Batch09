...
print("_"*50)
### 5.1 tuple -> int ### conversion is not possible
### 5.2 tuple -> float ### conversion is not possible
...
print("_"*50)
### 5.5 tuple -> dictionary ### convertion is not possible
...
########### 6. dictionary #############
## 6.1 dict -> int ## conversion is not possible
## 6.2 dict -> float ## conversion is not possible
print("_"*50)
#### 6.3 dict -> string ###
d1 = {'a': 234, 'b': 456}
s1 = str(d1)
...
print("_"*50)
############## 7. Set #####################
### 7.1 set ->  Int #### conversion is not possible
### 7.2 set ->  float ### conversion is not possible
### 7.3 set ->  string ###
set1 = {5, 7, 9, 22, 44, 'a'}
str1 = str(set1)
...
print("_"*50)
### 7.6 set ->  dict ### conversion is not possible
...
print("_"*50)
## 8.4 bool -> list ###  conversion not possible
"""
b3= True
l3 = list(b3)
print(l3, type(l3))
...
## 8.5 bool -> tuple ###  conversion not possible
## 8.6 bool -> dict ###  conversion not possible
## 8.7 bool -> set ###  conversion not possible